...
import org.plugins.rpghorses.guis.YourHorsesGUI;
...
public class MarketGUIManager {
    ...
    public void setupMarketGUI() {
        ...
        for (MarketHorse marketHorse : this.marketHorses) {
            ...
            ItemStack item = this.horseItem.clone();
    ...
    public void reloadMarketGUI() {
        ...
        for (HorseOwner horseOwner : this.horseOwnerManager.getHorseOwners()) {
            if (horseOwner.isInMarketInventory()) {
    ...
    private boolean reloadMarketFillItem() {
        ...
        return (oldMarketFillItem != null && this.marketFillItem == null) || (oldMarketFillItem == null && this.marketFillItem != null) || !oldMarketFillItem.isSimilar(this.marketFillItem);
    }
    ...
    private boolean reloadHorseItem() {
        ...
        return (oldHorseItem != null && this.horseItem == null) || (oldHorseItem == null && this.horseItem != null) || !oldHorseItem.isSimilar(this.horseItem);
    }
    ...
    private boolean reloadYourHorsesItem() {
        ...
        return (oldYourHorsesItem != null && this.yourHorsesItem == null) || (oldYourHorsesItem == null && this.yourHorsesItem != null) || !oldYourHorsesItem.isSimilar(this.yourHorsesItem);
    }
    ...
    private boolean reloadBackItem() {
        ...
        return (oldBackItem != null && this.backItem == null) || (oldBackItem == null && this.backItem != null) || !oldBackItem.isSimilar(this.backItem);
    }
